...
public class GlobalExceptionHandler {
	...
	public String handleIncorrectData(IncorrectData e) {
		return e.getMessage();
	}
	@ExceptionHandler(IncorrectDisplay.class)
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public String handleIncorrectDisplay(IncorrectDisplay e) {
		return e.getMessage();
	}
	@ExceptionHandler(IncorrectUpdate.class)
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public String handleIncorrectUpdate(IncorrectUpdate e) {
		return e.getMessage();
	}
	@ExceptionHandler(IncorrectDelete.class)
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public String handleIncorrectDelete(IncorrectDelete e) {
		return e.getMessage();
	}
